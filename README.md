# Angular7 - Chocolate-Boutique + Firebase
Developing a Chocolate-Boutique(Ecommerce) Application using Angular7.

## Preview
[Click here](https://choco-store.firebaseapp.com/)

## Functionalities

1.  User Registration using Firebase Authentication (using Google Authentication )
...
- Technology: HTML, CSS, Angular-7, Firebase, jsPDF (to download Receipt as PDF), etc.
...
9.  For Admin Role `Register or SignIn with Google Auth`
    ...
    your registered data will be saved inside the firebase **admin** table.
